"""
Regenerate every VEX belt-accelerator part: STEP + STL + preview PNG.

    python -m cad.export_all

Outputs land in cad/step, cad/stl, cad/previews. Also renders a colour-coded
assembly preview so you can see how the mechanism goes together with the
tri-ball loaded in the barrel.
"""
